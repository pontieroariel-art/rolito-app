...
exports.sincronizarSaldosTangoAhora = exports.sincronizarClientesTangoAhora = exports.syncSaldosTangoConnect = exports.syncClientesTangoConnect = exports.sincronizarPreciosTangoAhora = exports.syncPreciosTango = exports.barridoOutboxTango = exports.onOutboxPendiente = exports.avisarRendicionesPendientes = exports.barridoDescargasSinNumerar = exports.barridoBorradoresVencidos = exports.onOutboxConfirmado = exports.onCobranzaCreada = exports.onDescargaCamionCreada = exports.onRemitoCargaRegreso = exports.onRemitoCargaCreado = exports.onAnulacionEmitida = exports.onVentaVentanillaFacturada = exports.onVentaVentanillaCreada = exports.onVentaCamionFacturada = exports.onVentaCamionCreada = exports.onProduccionPalletCreado = exports.onConsultaRespondida = exports.syncSaldosTango = exports.syncClientesTango = exports.enviarResumenAdminDiario = exports.onHistorialAdminAltoRiesgo = exports.backupAuthUsers = exports.onVisitaSupervisorCreada = exports.onPedidoSupervisorCreado = exports.avisarComodatosPorVencer = exports.onTicketCreado = exports.onStockBajo = exports.onTicketCerrado = exports.generarPedidosRecurrentes = exports.orsDirections = exports.mirrorDriverLocation = exports.validarPreciosPedido = exports.notifyReprogramado = exports.notifyCerca = exports.sendPush = exports.deleteAuthUsers = exports.onOrderEnCamino = exports.onOrderConfirmado = exports.onOrderCreated = exports.onClienteIndexado = exports.onUserClaims = exports.onClienteCreadoPorStaff = exports.onUserApproved = exports.onUserRegistered = void 0;
exports.tokenAppCheckTele = exports.presentarCotRemito = exports.onRemitoCargaCotSolicitado = exports.resendWebhook = exports.enviarComprobantePorMail = exports.avisarPadronIIBB = exports.onCotError = exports.onCobranzaControl = exports.onVentaVentanillaControl = exports.onVentaCamionControl = exports.onDescargaRectificada = exports.verificarAnuladosEnTango = exports.onDesvioResuelto = exports.onDesvioSolicitado = exports.reconciliarRecibosAnulados = exports.onAnulacionReciboResuelta = exports.onAnulacionReciboSolicitada = exports.onDescargaMarcaRemito = exports.onDescargaContada = exports.rollupVentasProducto = exports.onProduccionPalletAnulado = exports.reconciliarRemitosAnulados = exports.onVentaVentanillaAnulada = exports.onVentaCamionAnulada = exports.onAnulacionResuelta = exports.onAnulacionSolicitada = exports.reconciliarFacturasArca = exports.onVentaVentanillaContadoFacturar = exports.onVentaContadoFacturar = exports.resetearPasswordStaff = exports.crearTokenImpersonacion = exports.resetPinProduccion = exports.onOrderRollup = exports.publicarMuelleEstadoBorrador = exports.publicarMuelleEstadoVentanilla = exports.publicarMuelleEstadoDescarga = exports.publicarMuelleEstadoRemito = exports.publicarTurnosVentanilla = exports.sincronizarDepositosTangoAhora = exports.syncDepositosTango = exports.procesarAltasTangoAhora = exports.altasClientesTango = exports.onConsultaSaldoPendiente = void 0;
...
var claims_1 = require("./triggers/claims");
Object.defineProperty(exports, "onUserClaims", { enumerable: true, get: function () { return claims_1.onUserClaims; } });
...
Object.defineProperty(exports, "onRemitoCargaRegreso", { enumerable: true, get: function () { return tangoOutbox_1.onRemitoCargaRegreso; } });
...
var barridosExpedicion_1 = require("./triggers/barridosExpedicion");
Object.defineProperty(exports, "barridoBorradoresVencidos", { enumerable: true, get: function () { return barridosExpedicion_1.barridoBorradoresVencidos; } });
Object.defineProperty(exports, "barridoDescargasSinNumerar", { enumerable: true, get: function () { return barridosExpedicion_1.barridoDescargasSinNumerar; } });
var avisosRendiciones_1 = require("./triggers/avisosRendiciones");
Object.defineProperty(exports, "avisarRendicionesPendientes", { enumerable: true, get: function () { return avisosRendiciones_1.avisarRendicionesPendientes; } });
...
Object.defineProperty(exports, "publicarMuelleEstadoBorrador", { enumerable: true, get: function () { return muelleEstado_1.publicarMuelleEstadoBorrador; } });
...
var impersonacion_1 = require("./triggers/impersonacion");
Object.defineProperty(exports, "crearTokenImpersonacion", { enumerable: true, get: function () { return impersonacion_1.crearTokenImpersonacion; } });
// El mail del staff es inventado, así que el "olvidé mi contraseña" lo hace el
// super_admin a mano (2026-09-20).
var staffPassword_1 = require("./triggers/staffPassword");
Object.defineProperty(exports, "resetearPasswordStaff", { enumerable: true, get: function () { return staffPassword_1.resetearPasswordStaff; } });
...
var ventasAnuladas_1 = require("./triggers/ventasAnuladas");
Object.defineProperty(exports, "onVentaCamionAnulada", { enumerable: true, get: function () { return ventasAnuladas_1.onVentaCamionAnulada; } });
Object.defineProperty(exports, "onVentaVentanillaAnulada", { enumerable: true, get: function () { return ventasAnuladas_1.onVentaVentanillaAnulada; } });
...
var produccionAnulada_1 = require("./triggers/produccionAnulada");
Object.defineProperty(exports, "onProduccionPalletAnulado", { enumerable: true, get: function () { return produccionAnulada_1.onProduccionPalletAnulado; } });
var ventasProductoRollup_1 = require("./triggers/ventasProductoRollup");
Object.defineProperty(exports, "rollupVentasProducto", { enumerable: true, get: function () { return ventasProductoRollup_1.rollupVentasProducto; } });
...
var descargaMarcaRemito_1 = require("./triggers/descargaMarcaRemito");
Object.defineProperty(exports, "onDescargaMarcaRemito", { enumerable: true, get: function () { return descargaMarcaRemito_1.onDescargaMarcaRemito; } });
...
var anuladosEnTango_1 = require("./triggers/anuladosEnTango");
Object.defineProperty(exports, "verificarAnuladosEnTango", { enumerable: true, get: function () { return anuladosEnTango_1.verificarAnuladosEnTango; } });
var descargaRectificada_1 = require("./triggers/descargaRectificada");
Object.defineProperty(exports, "onDescargaRectificada", { enumerable: true, get: function () { return descargaRectificada_1.onDescargaRectificada; } });
// Total de la venta contra sus renglones: marca y avisa si no cuadra (auditoría 2026-09-22).
var ventasControl_1 = require("./triggers/ventasControl");
Object.defineProperty(exports, "onVentaCamionControl", { enumerable: true, get: function () { return ventasControl_1.onVentaCamionControl; } });
Object.defineProperty(exports, "onVentaVentanillaControl", { enumerable: true, get: function () { return ventasControl_1.onVentaVentanillaControl; } });
// Recibo que no cuadra: se marca, se avisa y no viaja a Tango (auditoría 2026-09-22).
var cobranzasControl_1 = require("./triggers/cobranzasControl");
Object.defineProperty(exports, "onCobranzaControl", { enumerable: true, get: function () { return cobranzasControl_1.onCobranzaControl; } });
// COT rechazado por ARBA: push a caja, logística y super_admin (auditoría 2026-09-22).
var cotAviso_1 = require("./triggers/cotAviso");
Object.defineProperty(exports, "onCotError", { enumerable: true, get: function () { return cotAviso_1.onCotError; } });
...
// Resend avisa qué pasó con cada mail (entregado, rebotado, spam): estado real
// en mailsSalientes y en el comprobante; push a facturación si rebota (2026-09-24).
var resendWebhook_1 = require("./triggers/resendWebhook");
...
var appCheckTele_1 = require("./triggers/appCheckTele");
Object.defineProperty(exports, "tokenAppCheckTele", { enumerable: true, get: function () { return appCheckTele_1.tokenAppCheckTele; } });
