...
exports.mapaVentaAProduccion = mapaVentaAProduccion;
exports.sumarVendido = sumarVendido;
/**
 ...
 */
function mapaVentaAProduccion(articulosVenta, articulosProduccion) {
    const porCodigo = new Map();
    for (const mapa of articulosProduccion) {
        for (const [prodId, codigo] of Object.entries(mapa))
            if (codigo)
                porCodigo.set(codigo, prodId);
    }
    const out = {};
 ...
 */
function sumarVendido(ventas, ventaAProduccion, plantaDe) {
    const out = {};
...
//# sourceMappingURL=ventasProducto.js.map