...
exports.PercepcionSinVigencia = void 0;
exports.fechaDeVigencia = fechaDeVigencia;
exports.leerPercepcionDePerfil = leerPercepcionDePerfil;
...
function fechaDeVigencia(valor) {
    if (valor instanceof Date)
        return Number.isNaN(valor.getTime()) ? null : valor;
    if (typeof valor === 'string')
        return deTexto(valor);
    const conToDate = valor;
...
class PercepcionSinVigencia extends Error {
    constructor() {
        super('El cliente tiene alícuota de percepción de IIBB pero sin período de vigencia. ' +
            'No se puede saber si el padrón está al día, así que no se factura.');
        this.name = 'PercepcionSinVigencia';
    }
}
exports.PercepcionSinVigencia = PercepcionSinVigencia;
/**
 ...
 */
function leerPercepcionDePerfil(perfil, tributoId) {
    ...
    if (!vigenciaDesde || !vigenciaHasta)
        throw new PercepcionSinVigencia();
    return {
        alicuota,
        tributoId,
...
//# sourceMappingURL=percepcionPerfil.js.map