...
/** La porción de `Response` que consumen los clientes de ARCA. */
...
/** Firma del transporte. Se inyecta en los clientes para poder testear sin red. */
export type FetchArca = (url: string, init?: PedidoHttp) => Promise<RespuestaHttp>

const TIMEOUT_MS = 30_000

export const fetchArca: FetchArca = (url, init = {}) => {
