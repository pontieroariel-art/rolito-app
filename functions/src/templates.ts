...
export interface FacturaConProblema {
  ...
  total:         number
  fechaVenta:    unknown
  /** Ausente = factura. La nota de crédito de una anulación se avisa por el mismo canal. */
...
export interface ComprobanteMail {
  ...
  /** Envío en bloque: nombres de los PDF adjuntos (se listan en la tarjeta "Adjuntos"). */
  adjuntos?:  string[]
}
