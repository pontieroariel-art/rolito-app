...
const sqlLista = `
  ...
  FROM STA14 S
  -- COLLATE: STA14 y GVA14 tienen intercalaciones distintas (Latin1_General_BIN vs Modern_Spanish_CI_AI)
  JOIN GVA14 C ON C.COD_GVA14 COLLATE DATABASE_DEFAULT = S.COD_PRO_CL COLLATE DATABASE_DEFAULT
  OUTER APPLY (
