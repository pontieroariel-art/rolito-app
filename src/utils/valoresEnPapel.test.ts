...
describe('valores en papel', () => {
  it('lista cheques y retenciones con su recibo y cliente', () => {
    expect(papel.cheques).toEqual([{ cobranzaId: 'c1', numeroRecibo: 'RS-9', clienteNombre: 'Kiosco', numero: '77', bancoNombre: 'Galicia', fechaEmision: '2026-09-01', fechaAcreditacion: '2026-10-01', importe: 900, empresa: 'redonhielo', cobradoPor: 'N' }])
