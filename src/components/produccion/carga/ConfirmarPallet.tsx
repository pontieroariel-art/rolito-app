...
export default function ConfirmarPallet({ producto: p, codigoProximo, abiertaDesde, onConfirmar, onCancelar }: ConfirmarPalletProps) {
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-[clamp(1.5rem,3.4vh,2.25rem)] font-black tracking-wide leading-tight">CONFIRMAR E IMPRIMIR</span>
        </button>
