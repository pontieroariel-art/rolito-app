...
// Shell del módulo heladeras: el sidebar ES la navegación (logo, secciones,
// cuenta) — no hay Navbar global arriba, para no repetir dos capas de
// chrome. En mobile/tablet angosto el sidebar colapsa a un panel, con una
// franja mínima (logo + toggle) siempre visible arriba.
