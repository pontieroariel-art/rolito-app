  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto p-4 space-y-6 pb-10">
        ...
        {/* Stats del día */}
        <div>
          <p className="text-sm text-muted mb-3">Hoy — {new Date().toLocaleDateString('es-AR', { weekday: 'long', day: 'numeric', month: 'long' })}</p>
...
function AdminOrderCard({ order, choferes }) {
...
function ChoferManager({ choferes }) {
