      ...
      <main className="max-w-3xl mx-auto p-4 space-y-6 pb-10">
        <div className="flex flex-wrap justify-between items-center gap-3">
          <div>
            ...
            <p className="text-secundario text-sm">{heladeras.length} heladeras cargadas</p>
          </div>
        ...
        {filtradas.length === 0 ? (
          <div className="text-sm">
            <p className="text-secundario">No se encontraron heladeras con ese criterio.</p>
            {busqueda.trim() && (
            ...
            {filtradas.slice(0, visibles).map((h) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className={`text-xs text-right ${h.clienteAsignadoNombre ? 'text-gray-600' : 'text-secundario'}`}>
