    ...
    <div className="bg-white border border-gray-200 rounded-2xl p-4 flex justify-between items-center">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          disabled={qty === 0}
          className="w-11 h-11 rounded-full bg-white border border-gray-200 text-lg hover:border-accent transition-colors disabled:opacity-30 flex items-center justify-center text-gray-600"
        >
          −
        </button>
        <input
        ...
        <button
          onClick={() => onChange(qty + 1)}
          className="w-11 h-11 rounded-full bg-white border border-gray-200 text-lg hover:border-accent transition-colors flex items-center justify-center text-gray-600"
        >
          +
        </button>
      </div>
