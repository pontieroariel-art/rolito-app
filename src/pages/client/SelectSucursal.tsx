    ...
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="mb-8 flex flex-col items-center gap-3">
        ...
        <div className="text-center">
          ...
          <p className="text-muted text-sm mt-1">¿Desde qué sucursal vas a pedir?</p>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm space-y-3">
        {addresses.map((addr) => (
          <button
            ...
            className="w-full text-left bg-surface border border-border hover:border-accent/60 rounded-2xl px-5 py-4 transition-colors group"
          >
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="text-muted text-xl group-hover:text-accent group-hover:translate-x-1 transition-all shrink-0">
                →
              </span>
            </div>
          </button>
      ...
      {addresses.length === 0 && (
        <div className="w-full max-w-sm text-center mt-4">
          <p className="text-muted text-sm">No tenés sucursales registradas.</p>
          <p className="text-muted/60 text-xs mt-1">Pedile al administrador que agregue tu dirección.</p>
        </div>
      )}
    </div>
  )
